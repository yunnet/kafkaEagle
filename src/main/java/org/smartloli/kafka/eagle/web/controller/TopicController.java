...
public class TopicController {
    ...
    public ModelAndView topicCreateView(HttpSession session) {
        LOG.info("invoke topicCreateView::session={}", session);
    ...
    public ModelAndView topicMessageView(HttpSession session) {
        LOG.info("invoke topicMessageView::session={}", session);
        ModelAndView mav = new ModelAndView();
    ...
    public ModelAndView topicListView(HttpSession session) {
        LOG.info("invoke topicListView::session={}", session);
        ModelAndView mav = new ModelAndView();
    ...
    public ModelAndView topicMetaView(@PathVariable("tname") String tname, HttpServletRequest request) {
        LOG.info("invoke topicMetaView::tname={}, request={}", tname, request);
        ModelAndView mav = new ModelAndView();
    ...
    public ModelAndView successView(HttpSession session) {
        LOG.info("invoke successView::session={}", session);
        ModelAndView mav = new ModelAndView();
    ...
    public ModelAndView failedView(HttpSession session) {
        LOG.info("invoke failedView::session={}", session);
        ModelAndView mav = new ModelAndView();
    ...
    public void topicMetaAjax(@PathVariable("tname") String tname, HttpServletResponse response,
                              HttpServletRequest request) {
        LOG.info("invoke topicMetaAjax::tname={}, response={}, request={}", tname, response, request);
    ...
    public void topicListAjax(HttpServletResponse response, HttpServletRequest request) {
        LOG.info("invoke topicListAjax::response={}, request={}", response, request);
        response.setContentType("text/html;charset=utf-8");
        response.setCharacterEncoding("utf-8");
        response.setHeader("Charset", "utf-8");
        response.setHeader("Cache-Control", "no-cache");
        ...
        for (Object object : topics) {
            ...
            if (search.length() > 0 && search.equals(topic.getString("topic"))) {
                JSONObject obj = new JSONObject();
                String metaLinkElement =
                        "<a href='/ke/topic/meta/" + topic.getString("topic") + "/' target='_blank'>" + topic
                                .getString("topic") + "</a>";
                obj.put("id", topic.getInteger("id"));
                obj.put("topic", "<a href='/ke/topic/meta/" + topic.getString("topic") + "/' target='_blank'>" + topic
                        .getString("topic") + "</a>");
                obj.put("partitions",
                        topic.getString("partitions").length() > 50 ? topic.getString("partitions").substring(0, 50)
                                + "..." : topic.getString("partitions"));
                ...
                obj.put("operate",
                        "<a name='remove' href='#" + topic.getString("topic")
                                + "' class='btn btn-danger btn-xs' disabled='disabled'>Remove</a>&nbsp");
                aaDatas.add(obj);
    ...
    public ModelAndView topicAddForm(HttpSession session, HttpServletResponse response, HttpServletRequest request) {
        LOG.info("invoke topicAddForm::session={}, response={}, request={}", session, response, request);
        ModelAndView mav = new ModelAndView();
        ...
        Map<String, Object> respons =
                kafkaService.create(clusterAlias, ke_topic_name, ke_topic_partition, ke_topic_repli);
    ...
    public ModelAndView topicDelete(@PathVariable("topicName") String topicName, @PathVariable("token") String token,
                                    HttpSession session, HttpServletResponse response,
                                    HttpServletRequest request) {
        LOG.info("invoke topicDelete::topicName={}, token={}, session={}, response={}, request={}", topicName, token,
    ...
    public void topicSqlLogicalAjax(@RequestParam String sql, HttpSession session, HttpServletResponse response,
                                    HttpServletRequest request) {
        LOG.info("invoke topicSqlLogicalAjax::sql={}, session={}, response={}, request={}", sql, session, response,
                request);
        response.setContentType("text/html;charset=utf-8");
        response.setCharacterEncoding("utf-8");
        response.setHeader("Charset", "utf-8");
    ...
    public void topicSqlPhysicsAjax(@RequestParam String sql, HttpSession session, HttpServletResponse response,
                                    HttpServletRequest request) {
        LOG.info("invoke topicSqlPhysicsAjax::sql={}, session={}, response={}, request={}", sql, session, response,
                request);
        response.setContentType("text/html;charset=utf-8");
        response.setCharacterEncoding("utf-8");
        response.setHeader("Charset", "utf-8");
