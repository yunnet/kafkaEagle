...
public class OffsetMetadataServer {
	...
	public interface AsyncIface {
		public void system(String bootstrapServers, AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
		public void getOffset(String clusterAlias, AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
	}
	...
	public static class Client extends org.apache.thrift.TServiceClient implements Iface {
		...
		public String recv_getOffset() throws org.apache.thrift.TException {
			...
			throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT,
					"getOffset failed: unknown result");
		}
	}
	...
	public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
		...
		public static class system_call extends TAsyncMethodCall {
			private String bootstrapServers;

			public system_call(String bootstrapServers, org.apache.thrift.async.AsyncMethodCallback resultHandler,
		...
		public static class getOffset_call extends org.apache.thrift.async.TAsyncMethodCall {
			...
			public getOffset_call(String clusterAlias, org.apache.thrift.async.AsyncMethodCallback resultHandler,
					org.apache.thrift.async.TAsyncClient client,
					org.apache.thrift.protocol.TProtocolFactory protocolFactory,
					org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
				super(client, protocolFactory, transport, resultHandler, false);
	...
	public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
		...
		public static class system<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, system_args, Void> {
			...
			public void start(I iface, system_args args,
		...
		public static class getOffset<I extends AsyncIface>
				extends org.apache.thrift.AsyncProcessFunction<I, getOffset_args, String> {
			public getOffset() {
				super("getOffset");
			}
	...
	public static class system_args implements org.apache.thrift.TBase<system_args, system_args._Fields>,
			java.io.Serializable, Cloneable, Comparable<system_args> {
		private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("system_args");

		private static final org.apache.thrift.protocol.TField BOOTSTRAP_SERVERS_FIELD_DESC = new org.apache.thrift.protocol.TField(
				"bootstrapServers", org.apache.thrift.protocol.TType.STRING, (short) 1);
		...
		static {
			...
			tmpMap.put(_Fields.BOOTSTRAP_SERVERS, new org.apache.thrift.meta_data.FieldMetaData("bootstrapServers",
		...
		public system_args(String bootstrapServers) {
			this();
			this.bootstrapServers = bootstrapServers;
		}
		...
		/**
		 * Returns true if field bootstrapServers is set (has been assigned a
		...
		private static class system_argsStandardScheme extends StandardScheme<system_args> {
			...
			public void read(org.apache.thrift.protocol.TProtocol iprot, system_args struct)
			...
			public void write(org.apache.thrift.protocol.TProtocol oprot, system_args struct)
					throws org.apache.thrift.TException {
				struct.validate();
		...
		private static class system_argsTupleScheme extends TupleScheme<system_args> {
			...
			@Override
			public void write(org.apache.thrift.protocol.TProtocol prot, system_args struct)
					throws org.apache.thrift.TException {
			...
			@Override
			public void read(org.apache.thrift.protocol.TProtocol prot, system_args struct)
					throws org.apache.thrift.TException {
	...
	@SuppressWarnings("serial")
	public static class system_result implements org.apache.thrift.TBase<system_result, system_result._Fields>,
			java.io.Serializable, Cloneable, Comparable<system_result> {
		...
		private static class system_resultStandardScheme extends StandardScheme<system_result> {
			...
			public void read(org.apache.thrift.protocol.TProtocol iprot, system_result struct)
					throws org.apache.thrift.TException {
				org.apache.thrift.protocol.TField schemeField;
				iprot.readStructBegin();
				while (true) {
			...
			public void write(org.apache.thrift.protocol.TProtocol oprot, system_result struct)
					throws org.apache.thrift.TException {
				struct.validate();
		...
		private static class system_resultTupleScheme extends TupleScheme<system_result> {
			...
			@SuppressWarnings("unused")
			@Override
			public void write(org.apache.thrift.protocol.TProtocol prot, system_result struct)
					throws org.apache.thrift.TException {
				TTupleProtocol oprot = (TTupleProtocol) prot;
			}
			...
			@SuppressWarnings("unused")
			@Override
			public void read(org.apache.thrift.protocol.TProtocol prot, system_result struct)
					throws org.apache.thrift.TException {
				TTupleProtocol iprot = (TTupleProtocol) prot;
			}
		}
	...
	@SuppressWarnings("serial")
	public static class getOffset_args implements org.apache.thrift.TBase<getOffset_args, getOffset_args._Fields>,
			java.io.Serializable, Cloneable, Comparable<getOffset_args> {
		private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
				"getOffset_args");

		private static final org.apache.thrift.protocol.TField CLUSTER_ALIAS_FIELD_DESC = new org.apache.thrift.protocol.TField(
				"clusterAlias", org.apache.thrift.protocol.TType.STRING, (short) 1);
		...
		static {
			Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(
					_Fields.class);
			tmpMap.put(_Fields.CLUSTER_ALIAS, new org.apache.thrift.meta_data.FieldMetaData("clusterAlias",
					org.apache.thrift.TFieldRequirementType.DEFAULT,
					new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
			metaDataMap = Collections.unmodifiableMap(tmpMap);
		...
		private static class getOffset_argsStandardScheme extends StandardScheme<getOffset_args> {
			...
			public void read(org.apache.thrift.protocol.TProtocol iprot, getOffset_args struct)
					throws org.apache.thrift.TException {
				org.apache.thrift.protocol.TField schemeField;
				iprot.readStructBegin();
				while (true) {
			...
			public void write(org.apache.thrift.protocol.TProtocol oprot, getOffset_args struct)
					throws org.apache.thrift.TException {
				struct.validate();
		...
		private static class getOffset_argsTupleScheme extends TupleScheme<getOffset_args> {
			...
			@Override
			public void write(org.apache.thrift.protocol.TProtocol prot, getOffset_args struct)
					throws org.apache.thrift.TException {
				TTupleProtocol oprot = (TTupleProtocol) prot;
				BitSet optionals = new BitSet();
			...
			@Override
			public void read(org.apache.thrift.protocol.TProtocol prot, getOffset_args struct)
					throws org.apache.thrift.TException {
				TTupleProtocol iprot = (TTupleProtocol) prot;
				BitSet incoming = iprot.readBitSet(1);
				if (incoming.get(0)) {
	...
	@SuppressWarnings("serial")
	public static class getOffset_result implements org.apache.thrift.TBase<getOffset_result, getOffset_result._Fields>,
			java.io.Serializable, Cloneable, Comparable<getOffset_result> {
		private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
				"getOffset_result");
		...
		private static class getOffset_resultStandardScheme extends StandardScheme<getOffset_result> {
			...
			public void read(org.apache.thrift.protocol.TProtocol iprot, getOffset_result struct)
					throws org.apache.thrift.TException {
				org.apache.thrift.protocol.TField schemeField;
				iprot.readStructBegin();
				while (true) {
			...
			public void write(org.apache.thrift.protocol.TProtocol oprot, getOffset_result struct)
					throws org.apache.thrift.TException {
				struct.validate();
		...
		private static class getOffset_resultTupleScheme extends TupleScheme<getOffset_result> {
			...
			@Override
			public void write(org.apache.thrift.protocol.TProtocol prot, getOffset_result struct)
					throws org.apache.thrift.TException {
				TTupleProtocol oprot = (TTupleProtocol) prot;
				BitSet optionals = new BitSet();
