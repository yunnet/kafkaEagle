...
<script src="${springMacroRequestContext.contextPath}/static/js/plugins/d3/d3.js" type="text/javascript"></script>
<script src="${springMacroRequestContext.contextPath}/static/js/plugins/d3/d3.layout.js" type="text/javascript"></script>
<script src="${springMacroRequestContext.contextPath}/static/js/main/consumer/consumers.js" type="text/javascript"></script>
