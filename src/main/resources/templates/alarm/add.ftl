...
<script src="${springMacroRequestContext.contextPath}/static/js/plugins/magicsuggest/magicsuggest.js" type="text/javascript"></script>
<script src="${springMacroRequestContext.contextPath}/static/js/plugins/tokenfield/bootstrap-tokenfield.js" type="text/javascript"></script>
<script src="${springMacroRequestContext.contextPath}/static/js/main/alarm/add.js" type="text/javascript"></script>
